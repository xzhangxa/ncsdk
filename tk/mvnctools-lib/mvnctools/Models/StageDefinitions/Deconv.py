...
class Deconv(Op):
    ...
    def specific_details_push(self, target_container, instance):
        ...
        if instance.opParams is not None:
            target_container.push("dilation", Value(c_uint32(instance.opParams[0])))
        else:
    ...
    def adapt_fields(self, emulator, layer):
        ...
        emulator.padStyle = PadStyle.caffe
        ...
        opParamsTensor = PopulatedTensor(np.asarray([layer.dilationFactor]).astype(np.int32))
