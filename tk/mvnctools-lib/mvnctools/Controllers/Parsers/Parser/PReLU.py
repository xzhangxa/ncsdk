...
class PReLU(Layer):
    '''PReLU is similar to ReLU, with the exception that it
       can apply a ReLU with different negative
       slope per channel (positive slope is always 1).
    '''
    ...
    def loadTrainedParameters(self, **kwargs):
        self.negativeSlope = kwargs['perChannelNegativeSlope']