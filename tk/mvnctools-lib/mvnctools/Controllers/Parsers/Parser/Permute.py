...
class Permute(Layer):
    ...
    def get_mvtensor_permutation(self, input_layout, output_layout):
        ...
        permutation = operator.itemgetter(inv_perm_ref_to_in[0],
                                          ...
                                          inv_perm_ref_to_in[2])(self.permutation)
...
class PermuteFlatten(Permute):
    def __init__(self, base):
        super().__init__(base.getStringifiedName(), base.inputTensorNames, base.outputTensorNames)
